...
const HomePage = () => (
    <main>
        <div className="jumbotron jumbotron-fluid text-dark bg-light animated fadeIn">
            <h1 className="display-6 text-center">Christian Alejandro Agüero Chao</h1>
            <p className="lead text-center"><strong>Software developer</strong></p>
            <p className="lead text-center">Developed in the following Stack:</p>
            <hr className="my-4" />
